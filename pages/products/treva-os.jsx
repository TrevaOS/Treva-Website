          ...
          >
            ...
            <div className="space-y-3">
              <div className="bg-gray-100 rounded-xl p-4">
                ...
                <div className="text-white font-800 text-3xl">87<span className="text-gray-500 text-sm">/100</span></div>
              ...
              <div className="bg-gray-100 rounded-xl p-4">
                <div className="text-gray-500 text-xs mb-2">AI Recommendation</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
            {features.map(({ icon: Icon, title, desc }, i) => (
              <FadeIn key={title} delay={i * 0.08}>
                <div className="bg-white border border-gray-100 rounded-2xl p-7 card-glow">
                  <div className="w-11 h-11 rounded-xl bg-[rgba(41,200,213,0.08)] border border-gray-200 flex items-center justify-center mb-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3" noValidate>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="flex-1 bg-gray-100 border border-gray-200 rounded-lg px-4 py-3 text-gray-900 text-sm placeholder-[#4A5568] focus:outline-none focus:border-[#29C8D5] transition-colors"
                    />
